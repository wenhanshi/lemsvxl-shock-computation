...
void dbsk2d_ishock_pointpoint::set_n(double _n) {
    dbsk2d_ishock_pointpoint::_n = _n;
}

void dbsk2d_ishock_pointpoint::set_u(double _u) {
  dbsk2d_ishock_pointpoint::_u = _u;
}
