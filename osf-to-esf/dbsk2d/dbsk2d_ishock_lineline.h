...
private:
  ...
  VECTOR_TYPE _ul;  ///< angle of unit vcl_vector along left line (VECTOR_TYPE is double)
  VECTOR_TYPE _ur;
public:
    ...
    void set_thetaL(double _thetaL);

    void set_thetaR(double _thetaR);

    void set_lL(double _lL);

    void set_lR(double _lR);
...
private:
    ///< angle of unit vcl_vector along right line
