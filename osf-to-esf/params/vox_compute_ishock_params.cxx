...
{ 
  ...
  this->input_object_dir_.
      set_values(this->param_list_, 
                 "io", "input_object_dir",
                 "input object folder", "", 
                 "/home/wenhan/CLionProjects/osf_to_esf/test_build",
                 0, // for 0th input object
  ...
  // by wenhan
  // add the parameters of the load osf file (only for test)
  dbsk2d_load_osf_process pro4;
